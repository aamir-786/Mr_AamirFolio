...
const CounterService = {
  ...
  careerStartDate: new Date('2022-01-01'), // Year, Month (0-indexed), Day
  ...
  growthRates: {
    worksCompleted: 18,     // ~18 projects per year
    totalClients: 10,       // ~10 clients per year
    awardsWon: 2.4          // ~2.4 awards per year
  },
